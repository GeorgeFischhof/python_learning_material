...
Returns the current date and time, timezone can be given as a parameter.<br/>
`now = datetime.datetime.now()`

## datetime.datetime.utcnow()

**DEPRECATED, NOT GOOD, DO NOT USE !!**
...
Return a string representing the date and time in ISO 8601 format,<br/>
...
Return a datetime object corresponding to `date_string`,<br/>
parsed according to `format`.<br/>
(string parse time)

## datetime.datetime.strftime(format)

Return a string representing the date and time,<br/>
controlled by an explicit format string.<br/>
(string from time)
...
also standard date formats: ISO-8601, RFC 3339 (deviated from ISO-8601)

comparing the formats <br/>

...
A class contains attributes (data) and methods (functions) for the given type of object. <br/>
Data is usually encapsulated: can be read or written through methods. <br/>
Methods that directly set a value to or get a value from an attribute are called <br/>
`setters` and `getters`.
...
that Python calls when you have just created a new instance of this class. <br/>
...
Static methods have no knowledge about classes, neither instances. <br/>
They are just **standalone** functions put into a class because they
relate to the logic of the class.
